  ...
  return (
    <div className={`text-center`}>
        <div 
            ...
            className={`border-b-4 rounded-xl flex flex-col justify-end items-center gap-5 relative tablet:w-56 tablet:h-64 w-36 h-64 tablet:pb-8 pb-2 tablet:px-6 shadow-lg`}>
